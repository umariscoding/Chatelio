      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            ...
            <span className="block text-primary-600 xl:inline">Service</span>
          </h1>
        ...
        <div className="mt-20">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="pt-6">
              <div className="flow-root bg-secondary-50 rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  <div className="inline-flex items-center justify-center p-3 bg-primary-500 rounded-md shadow-lg">
                    <svg className="h-6 w-6 text-secondary-50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                    </svg>
                  </div>
                  <h3 className="mt-8 text-lg font-medium text-secondary-900 tracking-tight">Easy Setup</h3>
                  <p className="mt-5 text-base text-secondary-600">
            ...
            <div className="pt-6">
              <div className="flow-root bg-secondary-50 rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <h3 className="mt-8 text-lg font-medium text-secondary-900 tracking-tight">Smart AI</h3>
                  <p className="mt-5 text-base text-secondary-600">
            ...
            <div className="pt-6">
              <div className="flow-root bg-secondary-50 rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <h3 className="mt-8 text-lg font-medium text-secondary-900 tracking-tight">Custom Branding</h3>
                  <p className="mt-5 text-base text-secondary-600">
