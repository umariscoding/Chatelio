...
export default function SettingsPage() {
  ...
  const [publishData, setPublishData] = useState({
    ...
    chatbotTitle: companyAuth.company?.chatbot_title || companyAuth.company?.name || '',
    chatbotDescription: companyAuth.company?.chatbot_description || 'Get help with our services and products',
  });
  ...
  const handleUpdateChatbotInfo = async () => {
    try {
      ...
      const result = await dispatch(updateChatbotInfo({
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12 lg:h-96">
            ...
            <div className="bg-white/70 backdrop-blur-sm p-8 rounded-2xl border border-border-light shadow-sm hover:shadow-md transition-shadow flex flex-col">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-text-primary">Company URL</h2>
              </div>
                  ...
                  {showSlugSuccess && (
                    <div className="bg-gradient-to-r from-success-50 to-emerald-50 p-4 rounded-xl border border-success-200">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-success-800 font-medium">Slug updated successfully!</span>
                      </div>
                    </div>
                  )}
                </div>
            ...
            <div className="bg-white/70 backdrop-blur-sm p-8 rounded-2xl border border-border-light shadow-sm hover:shadow-md transition-shadow flex flex-col">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-text-primary">Chatbot Details</h2>
              </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm p-8 rounded-2xl border border-border-light shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-text-primary">Publishing Control</h2>
                  <p className="text-sm text-text-secondary mt-1">Make your chatbot publicly accessible</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                <div className="text-right">
                  ...
                  <p className="text-xs text-text-secondary">
                    {publishData.isPublished ? 'Publicly accessible' : 'Not accessible'}
                  </p>
                </div>
                <Toggle
              ...
              {!companyAuth.company?.slug && (
                <div className="bg-gradient-to-r from-warning-50 to-orange-50 p-6 rounded-xl border border-warning-200">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-warning-800 mb-1">Company Slug Required</h4>
                      <p className="text-sm text-warning-700">
                        Set a company slug in the section above before you can publish your chatbot.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
                    <div className="flex items-center space-x-3">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm font-medium text-text-primary">Live URL</span>
                      </div>
                    </div>
                    <div 
              ...
              {companyAuth.company?.slug && !publishData.isPublished && (
                <div className="bg-gradient-to-r from-neutral-50 to-gray-50 p-6 rounded-xl border border-neutral-200">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-neutral-800 mb-1">Chatbot is Private</h4>
                      <p className="text-sm text-neutral-600">
                        Toggle the switch above to make your chatbot publicly accessible
                      </p>
                    </div>
                  </div>
                </div>
